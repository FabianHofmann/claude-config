...
3. Run the /compactify and /test-refactor skills. Run the new and related tests to check for regressions.
4. Run the /diff-review skill. Fix nice-to-have issues that are cheap and in-scope; defer the rest with a one-line reason.
5. Run /compactify again.
6. Run the full test suite, including mypy and ruff if configured in the project.
7. Run the /add-release-notes skill.
